...
\begin{definition}
    ...
    \end{equation}
    where $\Response{x_t}{I_t}{\phi}$ will later denote the response. \footnote{The denotation $\Response{\cdot}{\cdot}{\phi}$ for response was choosen to show the similaritise with inner product.}

\end{definition}

Assuming $R$ render $x_t$ in the same way as the realworld renderer does we want to know 

How well this is obtained depends on the response curve
