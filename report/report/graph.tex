...
\begin{tikzpicture}[->,>=stealth',shorten >=1pt,auto,node distance=3cm,
  ...
  \node[main node] (1) {$Z_1$};
  \node[main node] (2) [right of=1] {$Z_2$};
  \node[main node] (3) [right of=2] {$Z_3$};
  \node[main node] (4) [right of=3] {$Z_4$};
  \node[main node] (u1) [below of=1] {$u_1$};
  \node[main node] (u2) [below of=2] {$u_2$};
  \node[main node] (u3) [below of=3] {$u_3$};
  \node[main node] (u4) [below of=4] {$u_4$};
  ...
  \path[every node/.style={font=\sffamily\small}]
    (1) edge node [below] {} (u1)
    (2) edge node [below] {} (u2)
    (3) edge node [below] {} (u3)
    (4) edge node [below] {} (u4);
