...
However, the tests for $p=8$ took a very long time to run, and some
tests did not finish in time. This included all tests for $n=512$ and
...
\begin{IEEEeqnarray}{rCl}
  E_{a,p} &=& E_{n_0, p, a, \sigma_0, g_0} ~ \forall p, a\\
  E_{s,g} &=& E_{n_0, p_0, a_0, \sigma, g} ~ \forall \sigma, g
\end{IEEEeqnarray}
...
the choice of $p$. However, the resulting $E_{a,p}$ and $E_{s,g}$ for
