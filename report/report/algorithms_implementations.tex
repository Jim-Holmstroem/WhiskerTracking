...
\begin{figure}
    \centering
    \includegraphics{response_curves.pdf}
    \caption{
    Response curves for varying the parameters of our polynomial model on generated whiskers images
    and having $\phi=1$
    }
    <<3 reponse curves, >>
\end{figure}
\begin{figure}
    \centering
    \includegraphics{response_curves_real.pdf}
    \caption{
    Response curves for varying the parameters or our polynomial model on real whisker images having $\phi=1$.
    Note the clutter effects giving faulty side peaks.
    }
