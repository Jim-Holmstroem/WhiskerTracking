...
oldtime=measure()
x_mask = parallel_map(lambda posx:response_circle((w/2+posx,h/2)).get_wimage().transform(abs_edge), x_range)
...
print "parallel:",measure()-oldtime
